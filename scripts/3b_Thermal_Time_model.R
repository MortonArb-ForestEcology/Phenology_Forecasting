...
#dir.create("/Users/jocelyngarcia/Documents/GitHub/Phenology_Forecasting/data_processed/model_output", recursive = T, showWarnings = F)
...
#dat.l <- read.csv("/Users/jocelyngarcia/Documents/GitHub/Phenology_Forecasting/data_processed/Oak_collection_leaf.csv")
